      ...
      <p> {{ this.$store.state.say }} </p>
        ...
        <table class="table table-striped mt-5" >
                ...
                <tbody>
                      ...
                      <tr v-for="(k,index) in kumpulanData">
                        <td>{{ index }} </td>
                        <td>{{ k.nama }} </td>
                        <td>{{ k.email}} </td>
                        <td> 
                              ...
                              <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModal1Label" aria-hidden="true">
                                  <div class="modal-dialog">
                                      ...
                                      <div class="modal-body">
                                        <div class="mb-3">
                                          <label for="nama1" class="form-label">Nama</label>
                                          <input type="text" v-model="findNama" class="form-control" id="nama1">
                                         
                                        </div>
                                        <div class="mb-3">
                                          <label for="exampleFormControlInput1" class="form-label">Email address</label>
                                          <input type="email" v-model="findEmail" class="form-control" id="exampleFormControlInput1">
